...
tf::Quaternion imu2LidarExtrinsicRot;
...
void readParameters(ros::NodeHandle &n)
{
    ...
    fsSettings["imu2LidarExtrinsicRotation"] >> cv_imu_2_lidar_R;
    cv::cv2eigen(cv_imu_2_lidar_R, eigen_imu_2_lidar_R);
    Eigen::Quaterniond Imu2LidarExtrinsicRot_(eigen_imu_2_lidar_R.block<3, 3>(0, 0));
    imu2LidarExtrinsicRot.setW( Imu2LidarExtrinsicRot_.w() );
    imu2LidarExtrinsicRot.setX( Imu2LidarExtrinsicRot_.x() );
    imu2LidarExtrinsicRot.setY( Imu2LidarExtrinsicRot_.y() );
    imu2LidarExtrinsicRot.setZ( Imu2LidarExtrinsicRot_.z() );
